...
const Card = ( {card}) => {
const {short_description, recipe_image, recipe_name, preparing_time, calories, ingredients} = card;
...
<div className="card border-[1px] border-solid p-6 ">
      ...
      <h4 className="text-[#282828] text-lg font-medium py-4">Ingredients: {ingredients.length}</h4>
      ...
      <button className="btn w-[172px] text-[#150B2B] text-lg font-medium rounded-[50px] bg-[#0BE58A]">Want to Cook</button>
